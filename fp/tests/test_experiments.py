...
class TestSuiteExperiments(unittest.TestCase):
    ...
    def test_logs(self):
        self.experiment.run()
        result_dir_files = os.listdir('logs/')
        result_sub_dir_files = os.listdir('logs/2020-01-01_00-00-00-000_test_dataset')
        result_optimal = read_csv('logs/2020-01-01_00-00-00-000_test_dataset/' +
                                  'test_dataset__no_pre_processing__complete_case__complete_data__no_scaler__DecisionTree-notuning__no_post_processing-48879__OPTIMAL.csv',
                                  header=None)
        self.assertEqual(result_dir_files[0], '2020-01-01_00-00-00-000_test_dataset')
        self.assertEqual(len(result_sub_dir_files), 2)
        self.assertEqual(result_optimal.shape, (300, 4))
